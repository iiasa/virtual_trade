...
$$
Virtual{\_}deforemission_{R,T}=Deforemis{\_}crop_{R,T}\times\frac{\Delta Crop{\_}area_{R,P,T}}{\sum^{P}_{P=1}\Delta Crop{\_}area_{R,P,T}}\times\frac{Virtual{\_}Crop{\_}area_{R,P,T}}{Crop{\_}area_{R,P,T}},\forall\Delta Crop{\_}area_{R,P,T}>0\qquad (7)
$$

$$
Virtual{\_}deforemission_{R,T}=Deforemis{\_}live_{R,T}\times\frac{\Delta Pasture_{R,P,T}}{\sum^{P}_{P=1}\Delta Pasture_{R,P,T}}\times\frac{Virtual{\_}Pasture_{R,P,T}}{Pasture_{R,P,T}},\forall\Delta Pasture_{R,P,T}>0\qquad (8)
$$